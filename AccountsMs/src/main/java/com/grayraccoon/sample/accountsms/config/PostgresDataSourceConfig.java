...
@EnableJpaRepositories(
        ...
        basePackages = { "com.grayraccoon.sample.accountsms.data.postgres.repository" }    // Repository Package
)
public class PostgresDataSourceConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(
        ...
        return builder
                ...
                .packages("com.grayraccoon.sample.accountsms.data.postgres.domain")    // Domain Package
